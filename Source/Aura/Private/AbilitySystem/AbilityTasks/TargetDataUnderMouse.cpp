...
{
	// Check to see if we need to send the mouse cursor data to the server
...
{
	// This tells the ability system that target data has been received, go ahead and clear the cached data
